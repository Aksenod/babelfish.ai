        ...
        <div className="space-y-4">
          <div className="bg-blue-50 border border-blue-200 rounded-lg p-3 mb-4">
            <p className="text-sm text-blue-800">
              💡 <strong>Совет:</strong> Ключи не обязательны. Если они не указаны, запросы идут на Vercel,
              где используются серверные ключи. Локальные ключи сохраняются в браузере и применяются только при вводе.
            </p>
          </div>
